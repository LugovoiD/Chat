        ...
        <div id="profile">
            <div className="wrap">
                ...
                <div id="expanded">
                    ...
                    {/*<label htmlFor="twitter"><i className="fa fa-twitter fa-fw"*/}
                    {/*                            aria-hidden="true"></i></label>*/}
                ...
                <li className="contact active">
                    <div className="wrap">
                        ...
                        <div className="meta">
                            ...
                            <p className="preview">Wrong. You take the gun, or you pull out a bigger one.
                                Or, you call their bluff. Or, you do any one of a hundred and forty six
                                other things.</p>
                        </div>
                    </div>
                </li>
